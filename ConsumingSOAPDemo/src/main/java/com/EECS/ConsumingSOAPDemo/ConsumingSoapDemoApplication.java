package com.EECS.ConsumingSOAPDemo;
...
public class ConsumingSoapDemoApplication implements CommandLineRunner {

	public static void main(String[] args) {
		SpringApplication.run(ConsumingSoapDemoApplication.class, args);
	}
